...
import utils
from model import GAT, pseuso_gat
...
class DAEGC(nn.Module):
    def __init__(self, num_features, hidden_size, embedding_size, alpha, num_clusters, v=1):
        ...
        self.gat = pseuso_gat(num_features, hidden_size).to(device)
        self.gat.load_state_dict(torch.load(args.pretrain_path, map_location=device))
